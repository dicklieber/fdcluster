...
class SessionManagerLogicSpec extends Specification {
  ...
  "SessionManagerLogicSpec" >> {
    ...
    "createSession" >> {
      ...
      val session: Session = sm.createSession(CreateSessionRequest("WA9NNN"))
    ...
    "expireSessions" >> {
      ...
      val session0: Session = sm.createSession(CreateSessionRequest("WA9NNN"))
      val session1: Session = sm.createSession(CreateSessionRequest("NE9A"))
