...
package org.wa9nnn.fdcluster.laureldb
...
object LaurelDbImporter {
  ...
  val store = new StoreMapImpl(nodeInfo, currentStationProvider, null, journalFilePath = Some(Paths.get("/Users/dlieber/fdcluster/journal1.log"))) //todo
